...
<body>
			...
			<div class="navbar-collapse collapse show"
				...
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item"><a class="nav-link"
						href="/patients/new">Add a Patient</a></li>
	...
	<main>
		<div class="container">
			<div class="row">
				<div class="col">
					<h1 class="display-1 textShadowSm text-center my-5">Edit
						Patient</h1>
				</div>
			</div>
			...
			<form:form action="/patients/${patient.id}/edit" method="post"
				modelAttribute="patient" class="my-5">
